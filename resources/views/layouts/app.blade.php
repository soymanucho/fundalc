...
<head>
  ...
  <title>{{ config('app.name', 'Fundacion Alcla') }}</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{route('home')}}" class="logo">
      ...
      <span class="logo-lg"><b>fund</b>alc</span>
    </a>
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="{{ route('change-pass')}}" class="btn btn-default btn-flat">Cambiar contraseña</a>
                  </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="www.fundalc.org">Fundación Alcla</a>.</strong> Todos los derechos reservados.
  </footer>
